...
public class DownloadPush {
    ...
    public static void subscribe(DownloadListener downloadListener) {
        DownloadFactory.getService(IMessageCenter.class).register(downloadListener);
    }
    ...
    public static void unSubscribe(String id) {
        DownloadFactory.getService(IMessageCenter.class).unRegister(id);
    }
    ...
    public static void unSubscribe(DownloadListener downloadListener) {
        DownloadFactory.getService(IMessageCenter.class).unRegister(downloadListener);
    }
    ...
    public static void pause(String id) {
        DownloadFactory.getService(IDownloadManager.class).pause(id);
    }
    ...
    public static void stop(String id) {
        DownloadFactory.getService(IDownloadManager.class).stop(id);
    }
    ...
    public static void deleteByTag(String tag) {
        DownloadFactory.getService(IDownloadManager.class).deleteByTag(tag);
    }
    ...
    public static void deleteById(String id) {
        DownloadFactory.getService(IDownloadManager.class).deleteById(id);
    }
    ...
    public static void resume(String id) {
        DownloadFactory.getService(IDownloadManager.class).resume(id);
    }

    public static void shutdown() {
        DownloadFactory.getService(IDownloadManager.class).shutdown();
    }
    ...
    public static List<DownloadInfo> getAllDownloadList() {
        return DownloadFactory.getService(IDownloadManager.class).getAllDownloadList();
    }

    public static List<DownloadInfo> getDownloadingList() {
        return DownloadFactory.getService(IDownloadManager.class).getDownloadingList();
    }

    public static List<DownloadInfo> getDownloadedList() {
        return DownloadFactory.getService(IDownloadManager.class).getDownloadedList();
    }
    ...
    public static List<DownloadInfo> getDownloadListByTag(String tag) {
        return DownloadFactory.getService(IDownloadManager.class).getDownloadListByTag(tag);
    }
    ...
    public static DownloadInfo getDownloadInfoById(String id) {
        return DownloadFactory.getService(IDownloadManager.class).getDownloadInfoById(id);
    }
    ...
    public static boolean hasDownloadSucceed(@NonNull String id) {
        return DownloadFactory.getService(IDownloadManager.class).hasDownloadSucceed(id);
    }
    ...
    public static File getFileIfSucceed(@NonNull String id) {
        return DownloadFactory.getService(IDownloadManager.class).getFileIfSucceed(id);
    }
