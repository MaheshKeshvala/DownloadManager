...
public class DownloadDispatcher extends Thread {
    ...
    boolean isUsableSpaceEnough(DownloadRequest downloadRequest) {
        ...
        if (dataFileUsableSpace <= minUsableStorageSpace) {
            ...
            DownloadFactory.getService(IMessageCenter.class).notifyProgressChanged(downloadInfo);
            return false;
        }
        return true;
    }
    ...
    long getMinUsableStorageSpace() {
        return DownloadFactory.getService(IDownloadConfigService.class).getMinUsableSpace();
    }
