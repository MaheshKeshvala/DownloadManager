...
import static com.mk.library.Manager.utils.ErrorCode.ERROR_CONTENT_LENGTH_NOT_FOUND;
import static com.mk.library.Manager.utils.Util.CONTENT_LENGTH_NOT_FOUND;
...
import com.mk.library.Manager.core.task.DownloadBlockTask;
import com.mk.library.Manager.core.task.DownloadTask;
import com.mk.library.Manager.core.task.Task;
import com.mk.library.Manager.db.DBService;
import com.mk.library.Manager.utils.DownloadProvider;
import com.mk.library.Manager.utils.ErrorCode;
import com.mk.library.Manager.utils.LogUtil;
import com.mk.library.Manager.utils.TaskManager;
...
public class ConnectInterceptor implements DownloadInterceptor {
    ...
    private boolean checkIsSpaceNotEnough(long contentLength) {
        ...
        long minUsableStorageSpace = DownloadFactory.getService(IDownloadConfigService.class).getMinUsableSpace();
    ...
    private DownloadConnection createConnection(DownloadRequest downloadRequest) {
        return DownloadFactory.getService(IDownloadConfigService.class).getDownloadConnectionFactory()
