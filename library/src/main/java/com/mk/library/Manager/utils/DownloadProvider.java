package com.mk.library.Manager.utils;
...
import com.mk.library.Manager.config.DownloadConfigService;
import com.mk.library.Manager.core.DownloadManager;
import com.mk.library.Manager.core.MessageCenter;
...
public class DownloadProvider extends ContentProvider {
    ...
    public static final String AUTHORITY_URI = "content://%s.mk.download-provider";
    ...
    public boolean onCreate() {
        ...
        DownloadFactory.addService(IDownloadManager.class, downloadManager);
        MessageCenter messageCenter = ReflectUtil.newInstance(MessageCenter.class);
        messageCenter.start(context);
        DownloadFactory.addService(IMessageCenter.class, messageCenter);
        IDownloadConfigService downloadConfig = ReflectUtil.newInstance(DownloadConfigService.class);
        DownloadFactory.addService(IDownloadConfigService.class, downloadConfig);
